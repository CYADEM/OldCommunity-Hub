package net.oldcommunity.hub.utilities.command;
            ...
            if (commandMap.containsKey(cmdLabel)) {
                ...
                if (!command.permission().equals("")) {
                    if (command.permission().equalsIgnoreCase("op") && !sender.isOp()) {
                        sender.sendMessage(ColorText.translate("&cNo permissions."));
                        return false;
                    }
                ...
                if (command.inGameOnly() && !(sender instanceof Player)) {
                    sender.sendMessage(ColorText.translate("&cYou must be player to perform this command."));
                    return true;
                }
                try {
